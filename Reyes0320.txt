...
-- Fecha    : 2026-03-20
-- Taller   : ALTER TABLE + UPDATE — tabla inscripcion
-- ============================================================

USE academia;
GO

-- 1. Agregar columna nota
--    DECIMAL(2,1): 2 digitos en total, 1 decimal (ej. 3.4)
ALTER TABLE inscripcion ADD nota DECIMAL(2,1);
GO

-- 2. Agregar columna semestre
ALTER TABLE inscripcion ADD semestre INT;
GO

-- 3. Restriccion CHECK: la nota debe estar entre 0 y 5
